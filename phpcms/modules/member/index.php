...
class index extends foreground {
	...
	public function init() {
		...
		$this->model=pc_base::load_model("model_model");
		$row=$this->model->get_one('modelid = '.$memberinfo[modelid]);
		$modelName=$row['name'];
		extract($memberinfo);
		if(mb_substr($modelName,-2,2,'UTF-8')!=='会员')$modelName.='会员';
	...
	public function register() {
		...
		if(isset($_POST['dosubmit'])) {
			...
			$userinfo['username'] = (isset($_POST['username']) && is_username($_POST['username'])) ? $_POST['username'] : (isset($_POST['email']) && is_email($_POST['email']))?$_POST['email']:'';
