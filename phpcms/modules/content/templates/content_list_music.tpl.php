		...
		<div class="explain-col">
				...
				<?php 
					if(isset($_GET['charid'])){
						...
						echo '<input name="charid" type="hidden"/>';
					}
...
<div class="table-list">
    <table width="100%">
        <thead>
            ...
            <th width="20"><?php echo L('listorder');?></th>
            <th width="40">ID</th>
			<th width="50"><?php echo L('music_name');?></th>
            <th width="40"><?php echo L('singer');?></th>
            <th width="40"><?php echo L('spName');?></th>
            <th width="40"><?php echo L('record_company');?></th>           
...
<tbody>
	...
	?>
        <tr>
		<td align="center"><input class="inputcheckbox " name="ids[]" sid="<?php echo $r['sid'];?>" value="<?php echo $r['id'];?>" type="checkbox"></td>
		...
		$(function(){
			...
			$(".joinChar").on("click",function(){
				if(status){
					...
					var ids=sids='';
					var str = 0;
					var table_a='<?php echo $_GET["selfid"]?>';
					...
					$.post(
						"<?php echo WEB_PATH;?>index.php?m=charts&c=charts&a=createChart",
						{table_a:table_a,sids:sids,ids:ids},
							function(statu){
