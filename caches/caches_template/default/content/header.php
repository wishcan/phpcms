...
<!-- 		<div class='top'>
		...
		<div class='center'>
			<div class='menu'>
				<a href="<?php echo APP_PATH;?>" target="_blank"><span>首页</span></a>
				<a href='<?php echo APP_PATH;?>index.php?m=about'target="_blank" ><span>榜单简介</span></a>
				<a href='<?php echo APP_PATH;?>index.php?m=content&c=index&a=lists&catid=9' target="_blank"><span>新闻资讯</span></a>
				<a href='<?php echo APP_PATH;?>index.php?m=content&c=index&a=lists&catid=12'target="_blank"><span>至尊推荐</span></a>
				<a href='<?php echo APP_PATH;?>index.php?m=music&c=index&a=vote' target="_blank"><span>网友投票</span></a>
				<a href='<?php echo APP_PATH;?>index.php?m=charts' target="_blank"><span>榜单回顾</span></a>
				<a href='<?php echo APP_PATH;?>index.php?m=content&c=index&a=lists&catid=15' target="_blank"><span>合作联盟</span></a>
				<a href='<?php echo APP_PATH;?>index.php?m=artistic' target="_blank"><span>艺术人生</span></a>
			</div>
		</div>
	</div>
	<!--LOGO 结束-->
