...
<div class='col_left l'>
	...
	<div class="vote border vote_<?php if($k==0) { ?>n<?php } elseif ($k==1) { ?>g<?php } elseif ($k==2) { ?>m<?php } ?>"name="vote_<?php if($k==0) { ?>n<?php } elseif ($k==1) { ?>g<?php } elseif ($k==2) { ?>m<?php } ?>" id="vote_<?php if($k==0) { ?>n<?php } elseif ($k==1) { ?>g<?php } elseif ($k==2) { ?>m<?php } ?>">     
	...
	<span class="vote_num "><?php echo $v['title'];?></span></h3>
		<div class='auto_c'>
			<ul>
				...
				<?php $n=1; if(is_array($v['data'])) foreach($v['data'] AS $n => $r) { ?>

				<?php $count=count($v['data']);?>
				<li>
